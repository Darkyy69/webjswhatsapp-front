...
export default function OrderFormManagerComponent() {
  ...
  const saveForm = async () => {
    ...
    setForms(
      forms.map((form) => (form.id === currentForm.id ? currentForm : form))
    );
  };
                  ...
                  <div key={index} className="mb-4 p-4 border rounded">
                    <div className="grid grid-cols-2 gap-4 mb-2">
                      <div>
                        ...
                        <Input
                          ...
                          value={field.input}
                          onChange={(e) =>
                            updateField(index, { input: e.target.value })
                          }
                        />
                      </div>
                      <div>
                        ...
                        <div className="flex">
                          <Input
                            ...
                            value={field.output || ""}
                            onChange={(e) =>
                              updateField(index, { output: e.target.value })
                            }
                            className="flex-grow"
                          />
                          <Button
                            variant="outline"
                            size="icon"
                            onClick={() => openLinkModal(currentForm.id, index)}
                            className="ml-2"
                          >
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-2">
                      <div>
                        ...
                        <Textarea
                          ...
                          value={field.text_ar}
                          onChange={(e) =>
                            updateField(index, { text_ar: e.target.value })
                          }
                          dir="rtl"
                        />
                      </div>
                      <div>
                        ...
                        <Textarea
                          ...
                          value={field.text_fr}
                          onChange={(e) =>
                            updateField(index, { text_fr: e.target.value })
                          }
                        />
                      </div>
                      <div>
                        ...
                        <Textarea
                          ...
                          value={field.text_en}
                          onChange={(e) =>
                            updateField(index, { text_en: e.target.value })
                          }
                        />
                      </div>
                    </div>
                    <div className="flex justify-between items-center">
                      <div className="flex-grow mr-2">
                        <Label htmlFor={`shortened_question-${index}`}>
                          Shortened Question
                        </Label>
                        <Input
                          ...
                          onChange={(e) =>
                            updateField(index, {
                              shortened_question: e.target.value,
                            })
                          }
                        />
                      </div>
